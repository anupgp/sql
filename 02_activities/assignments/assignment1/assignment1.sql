...
SELECT * from customer_purchases WHERE product_id like 4 or product_id like 9
...
SELECT 
--v.vendor_id, vendor_name, market_date, 
*
FROM vendor as v
...
SELECT vendor_id,
count(booth_number) as total_rentals
...
SELECT 
c.customer_first_name, customer_last_name,
